...
int main()
{
    ...
    unsigned char a[16] = "1111111111111111";
    unsigned char b[32] = {0xf0,0xb9,0x86,0x53,0x4a,0xd3,0x1c,0x21,0x0b,0x39,0xc7,0xad,0x08,0x7d,0x4d,0x8f};

    unsigned char c[16] = {0};

    sm4_one_enc((unsigned int*)mk,(unsigned int*) a,(unsigned int*) b);
    ...
    // sm4_one_dec((unsigned int *)mk, (unsigned int *)(b + 16), (unsigned int *)c);
    // for (size_t i = 0; i < 16; i++)
    // {
    //     printf("%c", c[i]);
    // }
